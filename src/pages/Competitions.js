        ...
        <div className='competitions'>
            ...
            <div className="row">
                <div className="col p-4 m-4">
                    <CompetitionCard detailsTitle="Details" rulesTitle="Rules" contactTitle="Contact" detailsText="Coming Soon1" rulesText="Coming Soon" contactText="Coming Soon" no="1" title="Optimization" text="Unleash the Power of Efficiency: Where Innovation Meets Optimization!" link="https://unstop.com/competitions/optimisation-exergy-2024-iit-kanpur-872244"/>
                </div>
                <div className="col p-4 m-4">
            ...
            <div className="row ">
                <div className="col p-4 m-4">
                    <CompetitionCard detailsTitle="Details" rulesTitle="Rules" contactTitle="Contact" detailsText="Coming Soon" rulesText="Coming Soon" contactText="Coming Soon" no="4" title="Case Study" text="Unlocking Insights, Solving Challenges: The Case Study Journey Begins!"  link="https://unstop.com/competitions/optimisation-exergy-2024-iit-kanpur-869781"/>
                </div>
                <div className="col p-4 m-4">
                <CompetitionCard detailsTitle="Details" rulesTitle="Rules" contactTitle="Contact" detailsText="Coming Soon" rulesText="Coming Soon" contactText="Coming Soon" no="3" title="StartUp Pitch" text="Turning Vision into Venture: Our Startup, Your Future." link="https://unstop.com/competitions/cheme-startup-pitch-exergy-2024-iit-kanpur-872769"/>
                </div>
            </div>
            <Footer/>
        </div>
